...
## Launch the project on development mode
One needs .env file in the root folder with the following variables:
  WIP

- In one terminal, one needs to launch the docker-compose file: 
