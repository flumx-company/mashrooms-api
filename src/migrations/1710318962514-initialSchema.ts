...
export class InitialSchema1710318962514 implements MigrationInterface {
    name = 'InitialSchema1710318962514'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`batches\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`name\` varchar(8) NULL, \`compostLoadDate\` date NOT NULL, \`compostSupplier\` varchar(50) NULL, \`compostWeight\` decimal(10,2) NOT NULL DEFAULT '0.00', \`briquetteQuantity\` decimal(10,2) NOT NULL DEFAULT '0.00', \`compostPrice\` decimal(10,2) NOT NULL DEFAULT '0.00', \`peatLoadDate\` date NOT NULL, \`peatSupplier\` varchar(50) NULL, \`peatWeight\` decimal(10,2) NOT NULL DEFAULT '0.00', \`peatPrice\` decimal(10,2) NOT NULL DEFAULT '0.00', \`dateFrom\` date NOT NULL, \`dateTo\` date NULL, \`waveQuantity\` decimal(2,0) NOT NULL DEFAULT '0', \`chamberId\` int NULL, INDEX \`IDX_94a720d7a8b59c3310ca8dafe4\` (\`name\`), INDEX \`IDX_889cb3fca0bba41b8d78e41dd7\` (\`dateFrom\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
