...
export class InitialSchema1710957074967 implements MigrationInterface {
    name = 'InitialSchema1710957074967'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`clients\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`firstName\` varchar(35) NULL, \`lastName\` varchar(35) NULL, \`patronymic\` varchar(35) NULL, \`nickname\` varchar(35) NULL, \`phone\` varchar(15) NULL, INDEX \`IDX_8a28b1e0e38fc81165d5dac229\` (\`lastName\`), INDEX \`IDX_aa22377d7d3e794ae4cd39cd9e\` (\`phone\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`varieties\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`name\` varchar(35) NULL, INDEX \`IDX_119f6fc825074d6121c59026c7\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`offloads\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`cuttingDate\` date NOT NULL, \`weight\` decimal(10,2) NOT NULL DEFAULT '0.00', \`amount\` decimal(5,0) NOT NULL DEFAULT '0', \`price\` decimal(10,2) NOT NULL DEFAULT '0.00', \`docId\` decimal(15,0) NOT NULL DEFAULT '0', \`priceId\` decimal(16,0) NOT NULL DEFAULT '0', \`authorId\` int NOT NULL, \`clientId\` int NOT NULL, \`driverId\` int NOT NULL, \`storeContainerId\` int NOT NULL, \`categoryId\` int NOT NULL, \`waveId\` int NOT NULL, \`varietyId\` int NOT NULL, \`batchId\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`cuttings\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`boxQuantity\` decimal(0,0) NOT NULL DEFAULT '0', \`trip\` decimal(0,0) NOT NULL DEFAULT '0', \`categoryId\` int NOT NULL, \`varietyId\` int NOT NULL, \`batchId\` int NOT NULL, \`waveId\` int NOT NULL, \`cutterShiftId\` int NOT NULL, \`authorId\` int NOT NULL, \`loaderShiftId\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
