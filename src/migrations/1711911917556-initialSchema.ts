...
export class InitialSchema1711911917556 implements MigrationInterface {
    name = 'InitialSchema1711911917556'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`prices\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`tenant\` enum ('BARREL', 'BOX', 'KITCHEN') NOT NULL DEFAULT 'BARREL', \`price\` decimal(10,2) NOT NULL DEFAULT '0.00', \`date\` date NOT NULL, INDEX \`IDX_99ec643394985350747a09d1dc\` (\`tenant\`), INDEX \`IDX_a2ac58aaa17a5670baa46ca26f\` (\`date\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
