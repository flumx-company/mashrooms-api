...
export class InitialSchema1711642301517 implements MigrationInterface {
    name = 'InitialSchema1711642301517'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`shifts\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`dateFrom\` date NOT NULL, \`dateTo\` date NULL, \`employeeId\` int NOT NULL, INDEX \`IDX_3a0e6f3a0fae1e7fac5ca3801d\` (\`dateTo\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`offloads\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`previousMoneyDebt\` decimal(10,2) NOT NULL DEFAULT '0.00', \`priceTotal\` decimal(10,2) NOT NULL DEFAULT '0.00', \`paidMoney\` decimal(10,2) NOT NULL DEFAULT '0.00', \`newMoneyDebt\` decimal(10,2) NOT NULL DEFAULT '0.00', \`delContainer1_7PreviousDebt\` decimal(5,0) NOT NULL DEFAULT '0', \`delContainer1_7In\` decimal(5,0) NOT NULL DEFAULT '0', \`delContainer1_7Out\` decimal(5,0) NOT NULL DEFAULT '0', \`delContainer1_7NewDebt\` decimal(5,0) NOT NULL DEFAULT '0', \`delContainer0_5PreviousDebt\` decimal(5,0) NOT NULL DEFAULT '0', \`delContainer0_5In\` decimal(5,0) NOT NULL DEFAULT '0', \`delContainer0_5Out\` decimal(5,0) NOT NULL DEFAULT '0', \`delContainer0_5NewDebt\` decimal(5,0) NOT NULL DEFAULT '0', \`delContainer0_4PreviousDebt\` decimal(5,0) NOT NULL DEFAULT '0', \`delContainer0_4In\` decimal(5,0) NOT NULL DEFAULT '0', \`delContainer0_4Out\` decimal(5,0) NOT NULL DEFAULT '0', \`delContainer0_4NewDebt\` decimal(5,0) NOT NULL DEFAULT '0', \`delContainerSchoellerPreviousDebt\` decimal(5,0) NOT NULL DEFAULT '0', \`delContainerSchoellerIn\` decimal(5,0) NOT NULL DEFAULT '0', \`delContainerSchoellerOut\` decimal(5,0) NOT NULL DEFAULT '0', \`delContainerSchoellerNewDebt\` decimal(5,0) NOT NULL DEFAULT '0', \`authorId\` int NOT NULL, \`clientId\` int NOT NULL, \`driverId\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
